...
import re
from ..UserComponent.UserService import UserService
...
def register_user_account(email, username, password, post_id = None):
    return UserService.register_user_account(email,username,password, post_id)
